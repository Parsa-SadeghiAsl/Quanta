...
from .views import (AccountViewSet, CategoryViewSet, TransactionViewSet,
                    BudgetViewSet, TransactionImportView, RecurringTransactionViewSet)
# Import the new analytics views
from .analytics_views import SummaryAnalyticsView, SpendingByCategoryAnalyticsView, BudgetProgressView, RecentTransactionsView
...
urlpatterns = [
    ...
    path("categories/mine/", CategoryViewSet.as_view({'get': 'mine'}), name="category-mine"),
    ...
    path("analytics/recent-transactions/", RecentTransactionsView.as_view(), name='recent-transactions'),
]